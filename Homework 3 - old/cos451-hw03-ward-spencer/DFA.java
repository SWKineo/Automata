...
public class DFA extends FSA {
     ...
     * @return The state determined by the transition function
     */
     ...
     * @param d2 The second DFA
     * @return The union of the two DFA's
     */
    ...
    /**
     * Converts the given DFA to an NFA, programmatically (this is a trivial
     * helper method used for processing input)
     * @param d The DFA to be converted to an NFA
     * @return The NFA generated from the given DFA
     */
